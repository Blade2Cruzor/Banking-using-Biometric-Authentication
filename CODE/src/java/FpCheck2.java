 ...
 * @author sluser
 */
@WebServlet(name = "FpCheck2", urlPatterns = {"/FpCheck2"})
public class FpCheck2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
         ...
         try {
            ...
            String saveFile="",cn="",score="",score1="";
...
// Process the uploaded items
            ...
            while (iter.hasNext()) {
                ...
                if (item.isFormField()) {
                    ...
                    else if (name.equalsIgnoreCase("score1")) {
                        score1 = value;
                        System.out.println("cn " + cn);
                    } 
                    else {
...
rst.close();
  ...
  System.out.println(blnResult);
       ...
       String qry = "select * from finger2 where cardno='"+cn+"'";
...
if(d>80)    
       {
             ...
             response.sendRedirect("TransOptions.jsp?cn="+cn+"&score2="+x+"&score="+score+"&score1="+score1);
           //response.sendRedirect("mail?cn="+cn+"");
       }
else if(x<10)
       {
          out.println("success"+x);
            response.sendRedirect("Fpauthentication_2.jsp?cn="+cn+"&score2="+x+"&score="+score+"&score1="+score1);    
       }
       else
       {
      
             response.sendRedirect("success_1.jsp?cn="+cn+"&score2="+x+"&score="+score+"&score1="+score1);
