 ...
 * @author sluser
 */
@WebServlet(name = "CreatecardCheck1", urlPatterns = {"/CreatecardCheck1"})
public class CreatecardCheck1 extends HttpServlet {
            ...
            FileInputStream fis;
                ...
                System.out.println(strDateNew);
                  ...
                  con=Db.con;
                   ...
                   String queryString = "insert into finger1 values (?,?,?)";
psmnt = con.prepareStatement(queryString);
                        ...
                        if(i==1){
                        response.sendRedirect("Createcard_2.jsp?cardno="+fn);
                        }
                    }
